...
public class I {
    ...
    private static void close() {
        ...
        for (int k = 0; k < B.j[0]; k++) {
            ...
            if (j2 <= 5) {
                if (j2 == B.j[10]) {
                    ...
                    if (k2 == 0)
                        ...
                        System.out.println((new StringBuilder()).append("Invalid face: ").append(k2).toString());
                } else if (j2 == B.j[15] || j2 == B.j[13]) {
                    k2 = -1;
                    flag = true;
                } else if (j2 >= B.j[16] && j2 <= B.j[19])
                    k2 = -1;
            } else {
                if ((k2 == 0 || k2 == 2) && j2 >= 10) {
                    int j4 = k3;
            ...
            if (i1 == 9374 || i1 == 4513 || i1 >= 4518 && i1 <= 4520 || i1 >= 5122 && i1 <= 5125 || i1 == 5112 || i1 >= 1140 && i1 <= 1205 || i1 >= 4735 && i1 <= 4740 || i1 <= 1299 && i1 >= 1298 || i1 == 1174 || i1 >= 446 && i1 <= 447 || i1 >= 1240 && i1 <= 1265 || i1 >= 950 && i1 <= 953 || i1 >= 4342 && i1 <= 4345 || i1 >= 3948 && i1 <= 3950 || i1 == 1032 || i1 == 4436 || i1 == 4446 || i1 == 4447) {
                flag = true;
                i3 = 1;
            } else if (i1 == 5113 || i1 >= 471 && i1 <= 474 || i1 == 1161 || i1 == 312 || i1 == 1341 || i1 >= 312 && i1 <= 313 || i1 == 1341 || i1 == 336 || i1 == 11603 || i1 >= 11930 && i1 <= 11945 || i1 == 11629 || i1 == 9623 || i1 == 1392 || i1 == 1394 || i1 >= 980 && i1 <= 982 || i1 == 1297 || i1 == 9375)
                i3 = 1;
            else if (j1 <= 2425 && k1 <= 3091 && j1 >= 2411 && k1 >= 3085 || j1 >= 2413 && k1 >= 3074 && j1 <= 2417 && k1 <= 3084 || j1 >= 2374 && k1 >= 3116 && j1 <= 2387 && k1 <= 3122 || j1 <= 2386 && k1 <= 3133 && j1 >= 2382 && k1 >= 3122)
                i3 = 1;
            else if (i1 >= 6716 && i1 <= 6750)
                k4 = -1;
            if (!flag)
                if (k3 >= 2 || l3 >= 2) {
    ...
    public static final boolean I(int height, int currentX, int currentY, int futureX, int futureY, int j1) {
        ...
        else if (VirtualWorld.I[k1].containsKey(z1))
