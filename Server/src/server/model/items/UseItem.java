    ...
    public static void ItemonItem(Client c, int itemUsed, int useWith) {
        ...
        if (itemUsed == 7786 && useWith == 4151) {
            if (c.playerLevel[c.playerSlayer] >= 80 && c.playerLevel[c.playerAttack] >= 99) {
                ...
                c.sendMessage("You made a Abyssal Vine whip.");
            } else {
                c.sendMessage("You need a slayer level of 80, and an attack level of 99 to make a vine whip.");
            }
        }
