	...
	public void destruct() {
		...
		EventManager.getSingleton().addEvent(new Event() {
			public void execute(EventContainer c) {
				...
				r3 = Misc.random(6);
				if (r3 == 0) {
					sendMessage("<shad=15695415>[Aggroth</col>]: Type ::vote and ::claim to get rewarded!!");
				} else if (r3 == 1) {           
					sendMessage("<shad=15695415>[Aggroth</col>]: Donations are appreciated thanks =)");		
				} else if (r3 == 2) { 
					sendMessage("<shad=15695415>[Aggroth</col>]: Register, type ::register!");
				} else if (r3 == 3) {
					sendMessage("<shad=15695415>[Aggroth</col>]: Feel free to ask any staff for help, as long as they're not busy!");
				} else if (r3 == 4) {
					sendMessage("<shad=15695415>[Aggroth</col>]: Please report all bugs to a staff.");
				} else if (r3 == 5) {
					sendMessage("<shad=15695415>[Aggroth</col>]: Dont forget to click save in your quest tab!");
				}
			}
