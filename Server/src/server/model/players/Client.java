...
public class Client extends Player {
    ...
    private Smithing smith;
    private Prayer prayer;
    private Curse curse;
    private Fletching fletching;
    private SmithingInterface smithingInterface;
    ...
    public Client(IoSession s, int _playerId) {
        ...
        smithingInterface = new SmithingInterface(this);
        farming = new Farming(this);
        thieving = new Thieving(this);
    ...
    public int getCombatLevel() {
        ...
        if (ran > attstr) {
            combatLevel = (int) (((getLevelForXP(playerXP[1])) * 0.25) + ((getLevelForXP(playerXP[3])) * 0.25) + ((getLevelForXP(playerXP[5])) * 0.125) + ((getLevelForXP(playerXP[4])) * 0.4875) + ((getLevelForXP(playerXP[22])) * 0.121212));
        } else if (mag > attstr) {
            combatLevel = (int) (((getLevelForXP(playerXP[1])) * 0.25) + ((getLevelForXP(playerXP[3])) * 0.25) + ((getLevelForXP(playerXP[5])) * 0.125) + ((getLevelForXP(playerXP[6])) * 0.4875) + ((getLevelForXP(playerXP[22])) * 0.121212));
        } else {
            combatLevel = (int) (((getLevelForXP(playerXP[1])) * 0.25) + ((getLevelForXP(playerXP[3])) * 0.25) + ((getLevelForXP(playerXP[5])) * 0.125) + ((getLevelForXP(playerXP[0])) * 0.325) + ((getLevelForXP(playerXP[2])) * 0.325) + ((getLevelForXP(playerXP[22])) * 0.121212));
        }
        return combatLevel;
    }
        ...
        if (playerRights >= 0) {
            for (int j = 0; j < Server.playerHandler.players.length; j++) {
                if (Server.playerHandler.players[j] != null) {
                    ...
                    c2.sendMessage("<shad=60811334>" + Misc.optimizeText(playerName) + " has logged in.</shad>");
                }
            }
        }
        synchronized (this) {

            sendMessage("Alert## Welcome to Aggroth ## Type ::vote for awesome rewards! ## UPDATES: The Ritual Quest and Bone Crusher added!");
            ...
            setSidebarInterface(14, 29265); //Staff tab by Shaloxis
            setSidebarInterface(15, 17000);//blank
            setSidebarInterface(16, 17011); //summon
            setSidebarInterface(0, 2423);
            clearQInterface();
            if (lastsummon > 0) {
                getSummoning().SummonNewNPC(lastsummon);
            }
/*if(totalstored > 0) {
    ...
    public SmithingInterface getSmithingInterface() {
