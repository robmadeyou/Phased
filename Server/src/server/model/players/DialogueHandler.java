...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		switch(dialogue) {
		case 998:
		sendStatement("Welcome to Aggroth, if you ever need something, let us know!");
		c.nextChat = 0;
		break;
		case 216:
		sendNpcChat4("Hello, welcome to the holy army of Aggroth.", "The soldiers drop Mystery Boxes.", "It sure is a good day to kill the army.", "When you have killed one, i will respawn them for you.", c.talkingNpc, "High Priest");
		c.nextChat = 0;
		break;
		case 1599:
		sendOption2("Teleport me to Shaloxis", "Don't teleport me.");
		c.nextChat = 0;
		c.teleAction = 1599;
		break;
		case 3515:
		...
		break;
		case 5759:
			sendNpcChat4("Hello, i am one of the shop keepers of Aggroth,", "Would you like to see what i have in stock?", "Then right click me, and select one of the shops.", "Good luck, young adventurer.", c.talkingNpc, "Skilling shopkeeper");
			c.nextChat = 0;
		break;
		case 1336:
			sendNpcChat4("Donating& Voting really helps Aggroth.", "If you wish to find out why, please visit our website.", "It can be found at http://aggroth.com/", "Thanks you.", c.talkingNpc, "Shaloxis");
		c.nextChat = 1337;
		break;
		case 1337:
		...
		break;
		case 4439:
			sendNpcChat4("Hello, i am the Points-Npc.", "I will explain you how the points we got work.", "PK points can be earned by killing a player.", "Thats simply it about the PK points, haha.", c.talkingNpc, "Aggroth Points");
			c.nextChat = 1350;
		break;
		case 1350:
		...
		break;
		case 4440:
			sendNpcChat4("And Aggroth Points can be earned by", "Leveling, Finishing a slayer task, or simply killing a player aswell.", "There will be points you earned, you can spend those in my shop.", "Good luck young adventurer.", c.talkingNpc, "Aggroth Points");
			c.nextChat = 4441;
		break;
                case 4441:
                sendOption3("Aggroth Points.", "Aggroth PK Points.", "Ah, nevermind");
		...
		case 4421:
				...
				break;
		case 4443:
			sendNpcChat4("Hello, i am one of the Aggroth Teleporters.", "I can teleport you to bosses, if you want.", "Beware, some of the bosses are strong!", "Good luck, young adventurer.", 598, "Boss teleporter");
			c.nextChat = 4444;
		break;
		case 4442:
			sendNpcChat4("Hello, i am one of the Aggroth Teleporters.", "I can teleport you to bosses, if you want.", "Beware, some of the bosses are strong!", "Good luck, young adventurer.", c.talkingNpc, "Boss teleporter");
			c.nextChat = 4445;
		break;
		case 4444:
			c.getDH().sendOption5("Tormented Demons", "King Black Dragons", "Dagganoths", "Lahkrahnaz", "Nomad");
			c.teleAction = 45;
			break;
		case 4445:
		...
		break;
		case 172:
			sendNpcChat4("Aggroth is based on a 317 PI, or project insanity.", "It has been coded and owned by Shaloxis.", "Our website can be found at http://aggroth.tk,", "or click the quest tab.", c.talkingNpc, "Old John");
			c.nextChat = 173;
		break;
		case 173:
	...
	case 51:
		...
		case 47:
			...
			break;
					case 235:
			sendOption2("Low Level Dungeon",  "High Level Dungeon");
			c.teleAction = 235;
			c.nextChat = 0;
			break;
		case 505:
