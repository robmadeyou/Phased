...
public abstract class Player {
    ...
    public final int[] BOWS = {904, 16337, 16887, 18357, 15241, 9185, 839, 845, 847, 851, 855, 859, 841, 843, 849, 853, 857, 861, 4212, 4214, 4215, 11235, 4216, 4217, 4218, 4219, 4220, 4221, 4222, 4223, 6724, 4734, 4934, 4935, 4936, 4937};
...
// Ancient Spells
    ...
    public boolean torva() {
        if (playerEquipment[playerHat] == 13362 && playerEquipment[playerLegs] == 13360 && playerEquipment[playerChest] == 13358) {
            return true;
        }
        return false;
    }
    ...
    public boolean fullDharoks() {
        return playerEquipment[playerHat] == 4716 && playerEquipment[playerLegs] == 4722 && playerEquipment[playerChest] == 4720 && playerEquipment[playerWeapon] == 4718;
    }
    ...
    public boolean fullVesta() {
        return playerEquipment[playerLegs] == 13893 && playerEquipment[playerChest] == 13887;
    }

    public boolean fullStatius() {
        return playerEquipment[playerLegs] == 13890 && playerEquipment[playerChest] == 13884;
    }
    ...
    public boolean fullPernix() {
        return playerEquipment[playerHat] == 20147 && playerEquipment[playerLegs] == 20155 && playerEquipment[playerChest] == 20151;
    }

    public boolean fullVirtus() {
        return playerEquipment[playerHat] == 20159 && playerEquipment[playerLegs] == 20167 && playerEquipment[playerChest] == 20163;
    }
    ...
    public boolean inWild() {
        ...
        if (absX > 2941 && absX < 3392 && absY > 3524 && absY < 3968 ||        //2941
                absX > 2941 && absX < 3392 && absY > 9918 && absY < 10367) {     //2941
            return true;
        }
        return false;
    }
    ...
    public boolean InDung() {
        if (absX >= 1755 && absX <= 1986 && absY >= 4500 && absY <= 4730) {
        /*absX >= 1755 && absX <= 2140 && absY >= 4500 && absY <= 4775 ||
		absX >= 2300 && absX <= 2400 && absY >= 4610 && absY <= 4800 ||
		absX >= 2943 && absX <= 3173 && absY >= 5117 && absY <= 5350 ||
		absX >= 2941 && absX <= 3173 && absY >= 5083 && absY <= 5314 ||
		absX >= 2873 && absX <= 3146 && absY >= 5006 && absY <= 5215 ||
		absX >= 2685 && absX <= 2900 && absY >= 9220 && absY <= 9435 ||
		absX >= 2760 && absX <= 2812 && absY >= 9505 && absY <= 9640 ||
		absX >= 3140 && absX <= 3280 && absY >= 9200 && absY <= 9347 ||
		absX >= 2800 && absX <= 2950 && absY >= 4570 && absY <= 4666 ||
		absX >= 2758 && absX <= 2810 && absY >= 4418 && absY <= 4463 ||
		absX >= 2800 && absX <= 2950 && absY >= 9905 && absY <= 9985 ||
		absX >= 2822 && absX <= 2876 && absY >= 9477 && absY <= 9532 ||
		absX >= 2368&& absX <= 2446 && absY >= 9408 && absY <= 9482 ||
		absX >= 2370 && absX <= 2430 && absY >= 5117 && absY <= 4701 ||
    ...
    public boolean safeZone() {
        if (absX > 2612 && absX < 2622 && absY > 3330 && absY < 3335
                ...
                || absX > 3072 && absX < 2620 && absY > 3129 && absY < 3518
