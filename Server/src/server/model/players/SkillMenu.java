...
public class SkillMenu {
	...
	private static final int[][] items = {{1321,1323,1325,1327,1329,1331,1333,4153,4587,4151,4718,11694,9747},
										  {1117,1115,1119,1125,1121,6916,1123,1127,3751,2513,10348,11724,11720,4720,11283,9753},
										  {4153,6528,9750},
										  {9768},
										  {841,843,849,853,857,1135,861,2499,11235,6522,2501,9185,18357,10330,4214,2503,4734,9756},
										  {9759},
	...
	private static final String[][] DESCRIPTION = {{"Bronze Weapons", "Iron Weapons", "Steel Weapons", "Black Weapons", 
	...
	/** cooking
	 * 
	 * 317,335,331,359,377,371,383,389,395,9801
	 * 1,15,25,30,40,45,80,91
	 * "Shrimp", "Trout", "Salmon", "Tuna", "Lobster", "Swordfish", "Shark", "Manta Ray","Cape of Achievement"
	 */
	
	/** fishing
	 * 
	 * 317,335,331,359,377,371,383,389,395,9801
	 * 1,20,30,35,40,50,76,81
	 * "Shrimp", "Trout", "Salmon", "Tuna", "Lobster", "Swordfish", "Shark", "Manta Ray","Cape of Achievement"
	 */
	...
	private static void removeSidebars(Client c) {
		...
		for (int j = 0; j < temp.length; j++) {
			c.getPlayerAssistant ().sendFrame126("",temp[j]);
		}
	}
	...
	private static void writeText(Client c, int skillType) {
		...
		for (int j = 0; j < LEVELS[skillType].length; j++) {
			c.getPlayerAssistant ().sendFrame126(LEVELS[skillType][j], LEVEL_LINE + j);
		}
		for (int j = 0; j < DESCRIPTION[skillType].length; j++) {
			c.getPlayerAssistant ().sendFrame126(DESCRIPTION[skillType][j], TEXT_LINE + j);
		}
