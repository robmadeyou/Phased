	...
	public void handleObject(Client c, int id, int x, int y) {
		switch (id) {
			case 4469:
				...
				if (x == 2426) {
					if (c.getY() == 3080)
						c.getPlayerAssistant ().movePlayer(2426, 3081, c.heightLevel);
					else if (c.getY() == 3081)
						c.getPlayerAssistant ().movePlayer(2426, 3080, c.heightLevel);
				} else if (x == 2422) {
					if (c.getX() == 2422)
						c.getPlayerAssistant ().movePlayer(2423, 3076, c.heightLevel);
					else if (c.getX() == 2423)
						c.getPlayerAssistant ().movePlayer(2422, 3076, c.heightLevel);
				}
			break;
			case 4470:
			...
			case 4411:
				if (x == 2421 && y == 3073 && c.heightLevel == 1)
					c.getPlayerAssistant ().movePlayer(c.getX(), c.getY(), 0);
			break;
			case 4419:
