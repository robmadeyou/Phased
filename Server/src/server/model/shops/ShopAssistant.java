...
public class ShopAssistant {
    ...
    public void openShop(int ShopID) {
        ...
        c.isShopping = true;
        c.myShopId = ShopID;
        c.getPlayerAssistant().sendFrame248(3824, 3822);
        c.getPlayerAssistant().sendFrame126(Server.shopHandler.ShopName[ShopID], 3901);
    }
    ...
    public void openPlayerShop(Client o) {
        ...
        c.isShopping = true;
        c.getPlayerAssistant().sendFrame248(3824, 3822);
        c.getPlayerAssistant().sendFrame126(o.playerName + "'s Shop!", 3901);
    }
    ...
    public void setupSkillCapes(int capes, int capes2) {
        synchronized (c) {
            ...
            c.myShopId = 14;
            c.getPlayerAssistant().sendFrame248(3824, 3822);
            c.getPlayerAssistant().sendFrame126("Skillcapes Shop", 3901);
    ...
    public void openVoid() {
			/*synchronized(c) {
				...
				c.myShopId = 15;
				c.getPlayerAssistant().sendFrame248(3824, 3822);
				c.getPlayerAssistant().sendFrame126("Void Recovery", 3901);
