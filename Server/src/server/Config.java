...
public class Config {
	...
	public static final boolean USE_MYSQL_SHIT = false;// TURN THIS TRUE TO TURN ON Vote, Highscores, etc. ~Sk8r
	...
	public static final int[] DESTROY_ITEMS =	{,};//You can add more items here.
