final class ObjectManager {
                    ...
                    for (int k17 = -5; k17 < anInt147 + 5; k17++) {
                        ...
                        if (k17 >= 1
                            ...
                            if (l18 > 0 || i19 > 0) {
                                ...
                                int i22 = 0;
                                if (j21 != -1)
                                    i22 = Texture.anIntArray1482[method187(k21,
                                            96)];
                                if (i19 == 0) {
                                    ...
                                    if (textureId >= 0) {
                                        k23 = Texture.method369(textureId);
                                        j23 = -1;
                                        ...
                                        k23 = Texture.anIntArray1482[method185(overlay_flo.anInt399, 96)];
                                        j23 = -2;
                                        textureId = -1;
                                    } else {
    ...
    private void method175(int i, WorldController worldController, Class11 class11, int j, int k, int l, int i1, int j1) {
        ...
        int l2 = l + (i << 7) + ((i1 > 0x7fff ? i1 & 0x7fff : i1) << 14) + 0x40000000;
        if (!class46.hasActions)
            l2 += 0x80000000;
        ...
        if (j == 22) {
            ...
            worldController.method280(k, k2, i, ((Animable) (obj)), byte0, l2, l, i1);
        ...
        if (j == 10 || j == 11) {
            ...
            if (obj1 != null) {
                ...
                if (worldController.method284(l2, byte0, k2, l4, ((Animable) (obj1)), j4, k, i5, i, l, i1) && class46.aBoolean779) {
                    Model model;
        ...
        if (j >= 12) {
            ...
            worldController.method284(l2, byte0, k2, 1, ((Animable) (obj2)), 1, k, 0, i, l, i1);
        ...
        if (j == 0) {
            ...
            worldController.method282(anIntArray152[j1], ((Animable) (obj3)), l2, i, byte0, l, null, k2, 0, k, i1);
            if (j1 == 0) {
        ...
        if (j == 1) {
            ...
            worldController.method282(anIntArray140[j1], ((Animable) (obj4)), l2, i, byte0, l, null, k2, 0, k, i1);
            if (class46.aBoolean779)
                if (j1 == 0)
                    aByteArrayArrayArray134[k][l][i + 1] = 50;
                else if (j1 == 1)
        ...
        if (j == 2) {
            ...
            worldController.method282(anIntArray152[j1], ((Animable) (obj11)), l2, i, byte0, l, ((Animable) (obj12)), k2, anIntArray152[i3], k, i1);
            if (class46.aBoolean764)
                if (j1 == 0) {
                    anIntArrayArrayArray135[k][l][i] |= 0x249;
                    anIntArrayArrayArray135[k][l][i + 1] |= 0x492;
        ...
        if (j == 3) {
            ...
            worldController.method282(anIntArray140[j1], ((Animable) (obj5)), l2, i, byte0, l, null, k2, 0, k, i1);
            if (class46.aBoolean779)
                if (j1 == 0)
                    aByteArrayArrayArray134[k][l][i + 1] = 50;
                else if (j1 == 1)
        ...
        if (j == 9) {
            ...
            worldController.method284(l2, byte0, k2, 1, ((Animable) (obj6)), 1, k, 0, i, l, i1);
            if (class46.aBoolean767 && class11 != null)
                class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, l, i, j1);
            return;
        }
