public final class RSInterface {
    ...
    public static void unpack(NamedArchive archive, RSFont rsFonts[], NamedArchive streamLoader_1) {
        ...
        while (stream.currentOffset < stream.buffer.length) {
            ...
            if (rsInterface.interfaceType == 2) {
                ...
                for (int l3 = 0; l3 < 5; l3++) {
                    ...
                    if (rsInterface.parentID == 3824)
                        rsInterface.itemActions[4] = "Buy 100";
            ...
            if (rsInterface.interfaceType == 4) {
                rsInterface.disabledMessage = stream.readString().replaceAll("RuneScape", "Aggroth");
    ...
    public static void playerinfo(RSFont[] TDA) {
        ...
        addText(26113, "Points", TDA, 0, 0xff9b00, false, true);
    ...
    public static void extraOptions(RSFont[] TDA) {
        ...
        index++;
        setBounds(27607, 70, 240, index, Interface);
        index++;
        setBounds(27502, 84, 63, index, Interface);
        index++;
        setBounds(27503, 83, 93, index, Interface);
        index++;
        setBounds(27504, 70, 123, index, Interface);
        index++;
        setBounds(27535, 83, 153, index, Interface);
        index++;
        ...
        index++;
        setBounds(27511, 40, 20, index, Interface);
        index++;
        setBounds(27513, 35, 50, index, Interface);
        index++;
        setBounds(27515, 35, 80, index, Interface);
        index++;
        setBounds(27522, 43, 140, index, Interface);
        index++;
        setBounds(27533, 43, 95, index, Interface);
        index++;
        setBounds(27608, 43, 170, index, Interface);
        index++;
        setBounds(27610, 43, 200, index, Interface);
        index++;
    }
    ...
    public static void emoteTab() {
        ...
        tab.totalChildren(1);
        tab.child(0, 148, 0, 3);
        AddInterfaceButton(168, 0, "Interfaces/Emotes/EMOTE", "Yes", 15113, 1, 41, 47);
        addTooltip(15113, "Yes");
        AddInterfaceButton(169, 1, "Interfaces/Emotes/EMOTE", "No", 15115, 1, 41, 47);
        addTooltip(15115, "No");
        AddInterfaceButton(164, 2, "Interfaces/Emotes/EMOTE", "Bow", 15117, 1, 41, 47);
        addTooltip(15117, "Bow");
        AddInterfaceButton(165, 3, "Interfaces/Emotes/EMOTE", "Angry", 15119, 1, 41, 47);
        addTooltip(15119, "Angry");
        AddInterfaceButton(162, 4, "Interfaces/Emotes/EMOTE", "Think", 15121, 1, 41, 47);
        addTooltip(15121, "Think");
        AddInterfaceButton(163, 5, "Interfaces/Emotes/EMOTE", "Wave", 15123, 1, 41, 47);
        addTooltip(15123, "Wave");
        AddInterfaceButton(13370, 6, "Interfaces/Emotes/EMOTE", "Shrug", 15125, 1, 41, 47);
        addTooltip(15125, "Shrug");
        AddInterfaceButton(171, 7, "Interfaces/Emotes/EMOTE", "Cheer", 15127, 1, 41, 47);
        addTooltip(15127, "Cheer");
        AddInterfaceButton(167, 8, "Interfaces/Emotes/EMOTE", "Beckon", 15129, 1, 41, 47);
        addTooltip(15129, "Beckon");
        AddInterfaceButton(170, 9, "Interfaces/Emotes/EMOTE", "Laugh", 15131, 1, 41, 47);
        addTooltip(15131, "Laugh");
        AddInterfaceButton(13366, 10, "Interfaces/Emotes/EMOTE", "Jump for Joy", 15133, 1, 41, 47);
        addTooltip(15133, "Jump for joy");
        AddInterfaceButton(13368, 11, "Interfaces/Emotes/EMOTE", "Yawn", 15135, 1, 41, 47);
        addTooltip(15135, "Yawn");
        AddInterfaceButton(166, 12, "Interfaces/Emotes/EMOTE", "Dance", 15137, 1, 41, 47);
        addTooltip(15137, "Dance");
        AddInterfaceButton(13363, 13, "Interfaces/Emotes/EMOTE", "Jig", 15139, 1, 41, 47);
        addTooltip(15139, "Jig");
        AddInterfaceButton(13364, 14, "Interfaces/Emotes/EMOTE", "Spin", 15141, 1, 41, 47);
        addTooltip(15141, "Spin");
        AddInterfaceButton(13365, 15, "Interfaces/Emotes/EMOTE", "Headbang", 15143, 1, 41, 47);
        addTooltip(15143, "Headbang");
        AddInterfaceButton(161, 16, "Interfaces/Emotes/EMOTE", "Cry", 15145, 1, 41, 47);
        addTooltip(15145, "Cry");
        AddInterfaceButton(11100, 17, "Interfaces/Emotes/EMOTE", "Blow kiss", 15147, 1, 41, 47);
        addTooltip(15147, "Blow kiss");
        AddInterfaceButton(13362, 18, "Interfaces/Emotes/EMOTE", "Panic", 15149, 1, 41, 47);
        addTooltip(15149, "Panic");
        AddInterfaceButton(13367, 19, "Interfaces/Emotes/EMOTE", "Raspberry", 15151, 1, 41, 47);
        addTooltip(15151, "Raspberry");
        AddInterfaceButton(172, 20, "Interfaces/Emotes/EMOTE", "Clap", 15153, 1, 41, 47);
        addTooltip(15153, "Clap");
        AddInterfaceButton(13369, 21, "Interfaces/Emotes/EMOTE", "Salute", 15155, 1, 41, 47);
        addTooltip(15155, "Salute");
        AddInterfaceButton(13383, 22, "Interfaces/Emotes/EMOTE", "Goblin Bow", 15157, 1, 41, 47);
        addTooltip(15157, "Goblin bow");
        AddInterfaceButton(13384, 23, "Interfaces/Emotes/EMOTE", "Goblin Salute", 15159, 1, 41, 47);
        addTooltip(15159, "Goblin salute");
        AddInterfaceButton(667, 24, "Interfaces/Emotes/EMOTE", "Freeze", 15161, 1, 41, 47);
        addTooltip(15161, "Freeze");
        AddInterfaceButton(6503, 25, "Interfaces/Emotes/EMOTE", "Trick", 15163, 1, 41, 47);
        addTooltip(15163, "Trick");
        AddInterfaceButton(6506, 26, "Interfaces/Emotes/EMOTE", "Safety First", 15189, 1, 41, 47);
        addTooltip(15189, "Safety First");
        AddInterfaceButton(666, 27, "Interfaces/Emotes/EMOTE", "Snowman Dance", 15167, 1, 41, 47);
        addTooltip(15167, "Snowman Dance");
        AddInterfaceButton(18464, 33, "Interfaces/Emotes/EMOTE", "Explore", 18000, 1, 41, 47);
        addTooltip(18000, "Explore");
        AddInterfaceButton(18465, 34, "Interfaces/Emotes/EMOTE", "Stomp", 17181, 1, 41, 47);
        addTooltip(17181, "Stomp");
        AddInterfaceButton(15166, 35, "Interfaces/Emotes/EMOTE", "Flap", 15183, 1, 41, 47);
        addTooltip(15183, "Flap");
        AddInterfaceButton(18686, 36, "Interfaces/Emotes/EMOTE", "FacePalm", 15185, 1, 43, 47);
        addTooltip(15185, "Slap head");
        AddInterfaceButton(18689, 28, "Interfaces/Emotes/EMOTE", "Zombie Walk", 15169, 1, 41, 47);
        addTooltip(15169, "Zombie walk");
        AddInterfaceButton(18688, 29, "Interfaces/Emotes/EMOTE", "Zombie Dance", 15171, 1, 41, 47);
        addTooltip(15171, "Zombie dance");
        AddInterfaceButton(18691, 30, "Interfaces/Emotes/EMOTE", "Bunny Hop", 15173, 1, 41, 47);
        addTooltip(15173, "Bunny Hop");
        AddInterfaceButton(18692, 37, "Interfaces/Emotes/EMOTE", "Zombie Hand", 15175, 1, 41, 47);
        addTooltip(15175, "Zombie hand");
        AddInterfaceButton(18687, 31, "Interfaces/Emotes/EMOTE", "Air Guitar", 15177, 1, 41, 47);
        addTooltip(15177, "Air Guitar");
        AddInterfaceButton(154, 32, "Interfaces/Emotes/EMOTE", "SkillCape", 15187, 1, 41, 47);
        addTooltip(15187, "Skillcape");
        ...
        scroll.child(28, 18464, 2 + 3, 349);
        scroll.child(29, 18465, 50 + 3, 350);
        ...
        scroll.child(65, 15167, 112, 276);//Row 7
        scroll.child(66, 15169, 0, 374);
        scroll.child(67, 15171, 44, 374);
        scroll.child(68, 15175, 88, 374);
        scroll.child(69, 15173, 129, 374);//Row 8
        scroll.child(70, 18000, 0, 325);
        scroll.child(71, 17181, 44, 325);
        scroll.child(72, 15183, 88, 325);
        scroll.child(73, 15185, 112, 325);//Row 9
        scroll.child(74, 15177, 0, 423);
        scroll.child(75, 15187, 44, 423);//Row 10
        scroll.width = 173;
        scroll.height = 255;
    ...
    public static void questTab(RSFont[] TDA) {
        ...
        addText(29155, "Information", 0xFF981F, false, true, 52, TDA, 2);
        ...
        setChildren(105, Interface);//0xFF981F for red text down there.
        addText(29161, "Quests:", 0xFF981F, false, true, 52, TDA, 2);
        addHoverText(29162, "http://insidiax.com/", "", TDA, 0, 0xff0000, false, true, 150);
        addHoverText(29163, "http://insidiax.com/", "", TDA, 0, 0xff0000, false, true, 150);
        addHoverText(29164, "http://insidiax.com/", "", TDA, 0, 0xff0000, false, true, 150);
        addHoverText(663, "http://insidiax.com/", "", TDA, 0, 0xff0000, false, true, 150);
    ...
    public static void extraEquipment(RSFont[] TDA) {
        ...
        AddInterfaceButton(27621, 3, "Interfaces/Equipment/BOX", "Godwars", 27640, 1, 40, 39);
        addTooltip(27640, "Instant Godwars Points");
        AddInterfaceButton(27622, 4, "Interfaces/Equipment/BOX", "Open Bank", 27642, 1, 40, 39);
        addTooltip(27642, "Instantly Open-Bank");
        ...
        addText(27625, "Instant Godwars Master:", 0xFF981F, false, true, 52, TDA, 2);
        addText(27647, "Get all kills required", 0xFF981F, false, true, 52, TDA, 0);
        addText(27626, "To fight the boss", 0xFF981F, false, true, 52, TDA, 0);
        addText(27627, "For instant acces!", 0xFF981F, false, true, 52, TDA, 0);
        addText(27628, "Open Bank:", 0xFF981F, false, true, 52, TDA, 2);
        addText(27629, "Open your bank", 0xFF981F, false, true, 52, TDA, 0);
        ...
        AddInterfaceButton(27635, 8, "Interfaces/Equipment/BOX", "Back", -1, 1, 71, 23);
        addTooltip(27648, "Go back");
        int last = 21;
        int frame = 0;
        setChildren(last, rsi);
        /** Buttons + text */
        setBounds(27621, 5, 5, frame, rsi);
        frame++;
        setBounds(27622, 75, 5, frame, rsi);
        frame++;
        setBounds(27623, 145, 5, frame, rsi);
        frame++;
        setBounds(27635, 55, 235, frame, rsi);
        frame++;
        setBounds(27636, 70, 240, frame, rsi);
        frame++;
        setBounds(27634, 0, 62, frame, rsi);
        frame++;
        setBounds(27624, 55, 46, frame, rsi);
        frame++;
        setBounds(27625, 15, 65, frame, rsi);
        frame++;
        setBounds(27647, 20, 80, frame, rsi);
        frame++;
        setBounds(27626, 20, 95, frame, rsi);
        frame++;
        setBounds(27627, 20, 110, frame, rsi);
        frame++;
        setBounds(27628, 15, 125, frame, rsi);
        frame++;
        setBounds(27629, 20, 140, frame, rsi);
        frame++;
        setBounds(27630, 20, 155, frame, rsi);
        frame++;
        setBounds(27631, 20, 170, frame, rsi);
        frame++;
        setBounds(27632, 15, 185, frame, rsi);
        frame++;
        setBounds(27633, 20, 200, frame, rsi);
        frame++;
        /** Tooltips */
        setBounds(27640, 10, 50, frame, rsi);
        frame++;
        setBounds(27642, 30, 50, frame, rsi);
        frame++;
        setBounds(27644, 35, 50, frame, rsi);
        frame++;
        setBounds(27648, 40, 240, frame, rsi);
        frame++;
    }
    ...
    public static void EquipmentTab(RSFont[] wid) {
        ...
        AddInterfaceButton(27651, 6, "Interfaces/Equipment/BOX", "Show your Donator Options", 27659, 1, 40, 33);
        addTooltip(27659, "Donator Options");
        AddInterfaceButton(27680, 7, "Interfaces/Equipment/BOX", "Show items On Death", 27681, 1, 40, 39); //80
        addTooltip(27681, "Show Items On Deatha");
        ...
        addTooltip(27657, "Lock/Unlock your XP");
        setChildren(7, Interface);
        setBounds(27651, 140, 205, 6, Interface);//Donor //0
        setBounds(27653, 10, 205, 1, Interface);//Equip
        setBounds(27654, 95, 205, 2, Interface);//XPlock
        setBounds(27680, 55, 205, 0, Interface);//iOd //6 //80
        setBounds(27659, 39, 240, 3, Interface);
        setBounds(27655, 39, 240, 4, Interface);
        setBounds(27657, 39, 240, 5, Interface);//iOd
    }
...
//Control 5 of main interface (Label)
    ...
    public static void NewSkillTab(RSFont[] TDA) {
        ...
        addButtons(31146, 3, "Interfaces/SkillTab/SKILL", "Quickchat your Hunter skill", 31237, 1);
        ...
        addButtons(31191, 14, "Interfaces/SkillTab/SKILL", "Quickchat your Summoning skill", 31237, 1);
        drawTooltip(31192, "EXP: 14000000");
        addText(31194, "99", 0xFFEE33, false, true, 52, TDA, 0);
        addText(31195, "99", 0xFFEE33, false, true, 52, TDA, 0);

        addButtons(31196, 0, "Interfaces/SkillTab/TOTAL", "View @or1@Total Level @whi@guide", 31197, 1);//,31197, 1
        drawTooltip(31197, "Your total level");
        addText(31199, "Total Level:", 0xFFEE33, false, true, 52, TDA, 0);
        addText(31200, "Total XP", 0xFFEE33, false, true, 52, TDA, 0);
        ...
        addButtons(31236, 23, "Interfaces/SkillTab/SKILL", "Quickchat your PK'ing skill", 31237, 1);
    ...
    public static void configureCharDesign(RSFont[] TDA) {
        ...
        addText(3649, "Welcome to Aggroth - Use the buttons below to design your player", TDA, 2, 0xFF9442);
        ...
        rsInterface.children = new int[142];
        rsInterface.childX = new int[142];
        rsInterface.childY = new int[142];
        rsInterface.children[0] = 3560;
        rsInterface.childX[0] = 12;
        rsInterface.childY[0] = 20;
        rsInterface.children[1] = 3561;
        rsInterface.childX[1] = 12;
        rsInterface.childY[1] = 80;
        rsInterface.children[2] = 3562;
        rsInterface.childX[2] = 12;
        rsInterface.childY[2] = 140;
        rsInterface.children[3] = 3563;
        rsInterface.childX[3] = 12;
        rsInterface.childY[3] = 200;
        rsInterface.children[4] = 3564;
        rsInterface.childX[4] = 12;
        rsInterface.childY[4] = 260;
        rsInterface.children[5] = 3565;
        rsInterface.childX[5] = 100;
        rsInterface.childY[5] = 20;
        rsInterface.children[6] = 3566;
        rsInterface.childX[6] = 100;
        rsInterface.childY[6] = 80;
        rsInterface.children[7] = 3567;
        rsInterface.childX[7] = 100;
        rsInterface.childY[7] = 140;
        rsInterface.children[8] = 3568;
        rsInterface.childX[8] = 100;
        rsInterface.childY[8] = 200;
        rsInterface.children[9] = 3569;
        rsInterface.childX[9] = 188;
        rsInterface.childY[9] = 20;
        rsInterface.children[10] = 3570;
        rsInterface.childX[10] = 100;
        rsInterface.childY[10] = 260;
        rsInterface.children[11] = 3571;
        rsInterface.childX[11] = 188;
        rsInterface.childY[11] = 80;
        rsInterface.children[12] = 3572;
        rsInterface.childX[12] = 188;
        rsInterface.childY[12] = 140;
        rsInterface.children[13] = 3573;
        rsInterface.childX[13] = 188;
        rsInterface.childY[13] = 200;
        rsInterface.children[14] = 3574;
        rsInterface.childX[14] = 188;
        rsInterface.childY[14] = 260;
        rsInterface.children[15] = 3575;
        rsInterface.childX[15] = 276;
        rsInterface.childY[15] = 20;
        rsInterface.children[16] = 3576;
        rsInterface.childX[16] = 364;
        rsInterface.childY[16] = 80;
        rsInterface.children[17] = 3577;
        rsInterface.childX[17] = 276;
        rsInterface.childY[17] = 80;
        rsInterface.children[18] = 3578;
        rsInterface.childX[18] = 276;
        rsInterface.childY[18] = 140;
        rsInterface.children[19] = 3579;
        rsInterface.childX[19] = 276;
        rsInterface.childY[19] = 200;
        rsInterface.children[20] = 3580;
        rsInterface.childX[20] = 276;
        rsInterface.childY[20] = 260;
        rsInterface.children[21] = 3581;
        rsInterface.childX[21] = 364;
        rsInterface.childY[21] = 140;
        rsInterface.children[22] = 3582;
        rsInterface.childX[22] = 364;
        rsInterface.childY[22] = 20;
        rsInterface.children[23] = 3583;
        rsInterface.childX[23] = 364;
        rsInterface.childY[23] = 200;
        rsInterface.children[24] = 3584;
        rsInterface.childX[24] = 364;
        rsInterface.childY[24] = 260;
        rsInterface.children[25] = 3585;
        rsInterface.childX[25] = 412;
        rsInterface.childY[25] = 20;
        rsInterface.children[26] = 3586;
        rsInterface.childX[26] = 412;
        rsInterface.childY[26] = 80;
        rsInterface.children[27] = 3587;
        rsInterface.childX[27] = 412;
        rsInterface.childY[27] = 140;
        rsInterface.children[28] = 3588;
        rsInterface.childX[28] = 412;
        rsInterface.childY[28] = 200;
        rsInterface.children[29] = 3589;
        rsInterface.childX[29] = 412;
        rsInterface.childY[29] = 260;
        rsInterface.children[30] = 3590;
        rsInterface.childX[30] = 12;
        rsInterface.childY[30] = 20;
        rsInterface.children[31] = 3591;
        rsInterface.childX[31] = -3;
        rsInterface.childY[31] = 49;
        rsInterface.children[32] = 3592;
        rsInterface.childX[32] = -3;
        rsInterface.childY[32] = 85;
        rsInterface.children[33] = 3593;
        rsInterface.childX[33] = -3;
        rsInterface.childY[33] = 121;
        rsInterface.children[34] = 3594;
        rsInterface.childX[34] = -3;
        rsInterface.childY[34] = 157;
        rsInterface.children[35] = 3595;
        rsInterface.childX[35] = -3;
        rsInterface.childY[35] = 193;
        rsInterface.children[36] = 3596;
        rsInterface.childX[36] = -3;
        rsInterface.childY[36] = 229;
        rsInterface.children[37] = 3597;
        rsInterface.childX[37] = -3;
        rsInterface.childY[37] = 265;
        rsInterface.children[38] = 3598;
        rsInterface.childX[38] = 479;
        rsInterface.childY[38] = 50;
        rsInterface.children[39] = 3599;
        rsInterface.childX[39] = 479;
        rsInterface.childY[39] = 86;
        rsInterface.children[40] = 3600;
        rsInterface.childX[40] = 479;
        rsInterface.childY[40] = 122;
        rsInterface.children[41] = 3601;
        rsInterface.childX[41] = 479;
        rsInterface.childY[41] = 158;
        rsInterface.children[42] = 3602;
        rsInterface.childX[42] = 479;
        rsInterface.childY[42] = 194;
        rsInterface.children[43] = 3603;
        rsInterface.childX[43] = 479;
        rsInterface.childY[43] = 230;
        rsInterface.children[44] = 3604;
        rsInterface.childX[44] = 479;
        rsInterface.childY[44] = 266;
        rsInterface.children[45] = 3605;
        rsInterface.childX[45] = 73;
        rsInterface.childY[45] = 299;
        rsInterface.children[46] = 3606;
        rsInterface.childX[46] = 109;
        rsInterface.childY[46] = 299;
        rsInterface.children[47] = 3607;
        rsInterface.childX[47] = 145;
        rsInterface.childY[47] = 299;
        rsInterface.children[48] = 3608;
        rsInterface.childX[48] = 181;
        rsInterface.childY[48] = 299;
        rsInterface.children[49] = 3609;
        rsInterface.childX[49] = 217;
        rsInterface.childY[49] = 299;
        rsInterface.children[50] = 3610;
        rsInterface.childX[50] = 253;
        rsInterface.childY[50] = 299;
        rsInterface.children[51] = 3611;
        rsInterface.childX[51] = 289;
        rsInterface.childY[51] = 299;
        rsInterface.children[52] = 3612;
        rsInterface.childX[52] = 325;
        rsInterface.childY[52] = 299;
        rsInterface.children[53] = 3613;
        rsInterface.childX[53] = 361;
        rsInterface.childY[53] = 299;
        rsInterface.children[54] = 3614;
        rsInterface.childX[54] = 397;
        rsInterface.childY[54] = 299;
        rsInterface.children[55] = 3615;
        rsInterface.childX[55] = 433;
        rsInterface.childY[55] = 299;
        rsInterface.children[56] = 3616;
        rsInterface.childX[56] = 72;
        rsInterface.childY[56] = 5;
        rsInterface.children[57] = 3617;
        rsInterface.childX[57] = 108;
        rsInterface.childY[57] = 5;
        rsInterface.children[58] = 3618;
        rsInterface.childX[58] = 144;
        rsInterface.childY[58] = 5;
        rsInterface.children[59] = 3619;
        rsInterface.childX[59] = 180;
        rsInterface.childY[59] = 5;
        rsInterface.children[60] = 3620;
        rsInterface.childX[60] = 216;
        rsInterface.childY[60] = 5;
        rsInterface.children[61] = 3621;
        rsInterface.childX[61] = 252;
        rsInterface.childY[61] = 5;
        rsInterface.children[62] = 3622;
        rsInterface.childX[62] = 288;
        rsInterface.childY[62] = 5;
        rsInterface.children[63] = 3623;
        rsInterface.childX[63] = 324;
        rsInterface.childY[63] = 5;
        rsInterface.children[64] = 3624;
        rsInterface.childX[64] = 360;
        rsInterface.childY[64] = 5;
        rsInterface.children[65] = 3625;
        rsInterface.childX[65] = 396;
        rsInterface.childY[65] = 5;
        rsInterface.children[66] = 3626;
        rsInterface.childX[66] = 432;
        rsInterface.childY[66] = 5;
        rsInterface.children[67] = 3627;
        rsInterface.childX[67] = 252;
        rsInterface.childY[67] = 34;
        rsInterface.children[68] = 3628;
        rsInterface.childX[68] = 37;
        rsInterface.childY[68] = 5;
        rsInterface.children[69] = 3629;
        rsInterface.childX[69] = 37;
        rsInterface.childY[69] = 299;
        rsInterface.children[70] = 3630;
        rsInterface.childX[70] = 12;
        rsInterface.childY[70] = 290;
        rsInterface.children[71] = 3631;
        rsInterface.childX[71] = 475;
        rsInterface.childY[71] = 20;
        rsInterface.children[72] = 3632;
        rsInterface.childX[72] = 439;
        rsInterface.childY[72] = 5;
        rsInterface.children[73] = 3633;
        rsInterface.childX[73] = 475;
        rsInterface.childY[73] = 290;
        rsInterface.children[74] = 3634;
        rsInterface.childX[74] = 439;
        rsInterface.childY[74] = 299;
        rsInterface.children[75] = 3635;
        rsInterface.childX[75] = 288;
        rsInterface.childY[75] = 34;
        rsInterface.children[76] = 3636;
        rsInterface.childX[76] = 324;
        rsInterface.childY[76] = 34;
        rsInterface.children[77] = 3637;
        rsInterface.childX[77] = 360;
        rsInterface.childY[77] = 34;
        rsInterface.children[78] = 3638;
        rsInterface.childX[78] = 396;
        rsInterface.childY[78] = 34;
        rsInterface.children[79] = 3639;
        rsInterface.childX[79] = 432;
        rsInterface.childY[79] = 34;
        rsInterface.children[80] = 3640;
        rsInterface.childX[80] = 459;
        rsInterface.childY[80] = 34;
        rsInterface.children[81] = 3641;
        rsInterface.childX[81] = 216;
        rsInterface.childY[81] = 34;
        rsInterface.children[82] = 3642;
        rsInterface.childX[82] = 180;
        rsInterface.childY[82] = 34;
        rsInterface.children[83] = 3643;
        rsInterface.childX[83] = 144;
        rsInterface.childY[83] = 34;
        rsInterface.children[84] = 3644;
        rsInterface.childX[84] = 108;
        rsInterface.childY[84] = 34;
        rsInterface.children[85] = 3645;
        rsInterface.childX[85] = 72;
        rsInterface.childY[85] = 34;
        rsInterface.children[86] = 3646;
        rsInterface.childX[86] = 36;
        rsInterface.childY[86] = 34;
        rsInterface.children[87] = 3647;
        rsInterface.childX[87] = 17;
        rsInterface.childY[87] = 34;
        rsInterface.children[88] = 3648;
        rsInterface.childX[88] = 36;
        rsInterface.childY[88] = 20;
        rsInterface.children[89] = 3649;
        rsInterface.childX[89] = 28;
        rsInterface.childY[89] = 29;
        rsInterface.children[90] = 3650;
        rsInterface.childX[90] = 190;
        rsInterface.childY[90] = 155;
        rsInterface.children[91] = 3651;
        rsInterface.childX[91] = 223;
        rsInterface.childY[91] = 266;
        rsInterface.children[92] = 3652;
        rsInterface.childX[92] = 237;
        rsInterface.childY[92] = 274;
        rsInterface.children[93] = 3653;
        rsInterface.childX[93] = 217;
        rsInterface.childY[93] = 260;
        rsInterface.children[94] = 3654;
        rsInterface.childX[94] = 270;
        rsInterface.childY[94] = 260;
        rsInterface.children[95] = 3655;
        rsInterface.childX[95] = 217;
        rsInterface.childY[95] = 273;
        rsInterface.children[96] = 3656;
        rsInterface.childX[96] = 270;
        rsInterface.childY[96] = 273;
        rsInterface.children[97] = 3657;
        rsInterface.childX[97] = 326;
        rsInterface.childY[97] = 74;
        rsInterface.children[98] = 3658;
        rsInterface.childX[98] = 90;
        rsInterface.childY[98] = 151;
        rsInterface.children[99] = 3659;
        rsInterface.childX[99] = 27;
        rsInterface.childY[99] = 68;
        rsInterface.children[100] = 3660;
        rsInterface.childX[100] = 27;
        rsInterface.childY[100] = 103;
        rsInterface.children[101] = 3661;
        rsInterface.childX[101] = 27;
        rsInterface.childY[101] = 138;
        rsInterface.children[102] = 3662;
        rsInterface.childX[102] = 27;
        rsInterface.childY[102] = 173;
        rsInterface.children[103] = 3663;
        rsInterface.childX[103] = 27;
        rsInterface.childY[103] = 208;
        rsInterface.children[104] = 3664;
        rsInterface.childX[104] = 27;
        rsInterface.childY[104] = 243;
        rsInterface.children[105] = 3665;
        rsInterface.childX[105] = 27;
        rsInterface.childY[105] = 278;
        rsInterface.children[106] = 3666;
        rsInterface.childX[106] = 140;
        rsInterface.childY[106] = 68;
        rsInterface.children[107] = 3667;
        rsInterface.childX[107] = 140;
        rsInterface.childY[107] = 103;
        rsInterface.children[108] = 3668;
        rsInterface.childX[108] = 140;
        rsInterface.childY[108] = 138;
        rsInterface.children[109] = 3669;
        rsInterface.childX[109] = 140;
        rsInterface.childY[109] = 173;
        rsInterface.children[110] = 3670;
        rsInterface.childX[110] = 140;
        rsInterface.childY[110] = 208;
        rsInterface.children[111] = 3671;
        rsInterface.childX[111] = 140;
        rsInterface.childY[111] = 243;
        rsInterface.children[112] = 3672;
        rsInterface.childX[112] = 140;
        rsInterface.childY[112] = 278;
        rsInterface.children[113] = 3673;
        rsInterface.childX[113] = 90;
        rsInterface.childY[113] = 184;
        rsInterface.children[114] = 3674;
        rsInterface.childX[114] = 91;
        rsInterface.childY[114] = 254;
        rsInterface.children[115] = 3675;
        rsInterface.childX[115] = 91;
        rsInterface.childY[115] = 79;
        rsInterface.children[116] = 3676;
        rsInterface.childX[116] = 88;
        rsInterface.childY[116] = 219;
        rsInterface.children[117] = 3677;
        rsInterface.childX[117] = 91;
        rsInterface.childY[117] = 288;
        rsInterface.children[118] = 3678;
        rsInterface.childX[118] = 94;
        rsInterface.childY[118] = 114;
        rsInterface.children[119] = 3679;
        rsInterface.childX[119] = 440;
        rsInterface.childY[119] = 74;
        rsInterface.children[120] = 3680;
        rsInterface.childX[120] = 326;
        rsInterface.childY[120] = 144;
        rsInterface.children[121] = 3681;
        rsInterface.childX[121] = 326;
        rsInterface.childY[121] = 109;
        rsInterface.children[122] = 3682;
        rsInterface.childX[122] = 326;
        rsInterface.childY[122] = 179;
        rsInterface.children[123] = 3683;
        rsInterface.childX[123] = 326;
        rsInterface.childY[123] = 214;
        rsInterface.children[124] = 3684;
        rsInterface.childX[124] = 87;
        rsInterface.childY[124] = 55;
        rsInterface.children[125] = 3685;
        rsInterface.childX[125] = 440;
        rsInterface.childY[125] = 109;
        rsInterface.children[126] = 3686;
        rsInterface.childX[126] = 391;
        rsInterface.childY[126] = 55;
        rsInterface.children[127] = 3687;
        rsInterface.childX[127] = 440;
        rsInterface.childY[127] = 144;
        rsInterface.children[128] = 3688;
        rsInterface.childX[128] = 440;
        rsInterface.childY[128] = 179;
        rsInterface.children[129] = 3689;
        rsInterface.childX[129] = 440;
        rsInterface.childY[129] = 214;
        rsInterface.children[130] = 3690;
        rsInterface.childX[130] = 394;
        rsInterface.childY[130] = 86;
        rsInterface.children[131] = 3691;
        rsInterface.childX[131] = 390;
        rsInterface.childY[131] = 121;
        rsInterface.children[132] = 3692;
        rsInterface.childX[132] = 392;
        rsInterface.childY[132] = 155;
        rsInterface.children[133] = 3693;
        rsInterface.childX[133] = 393;
        rsInterface.childY[133] = 225;
        rsInterface.children[134] = 3694;
        rsInterface.childX[134] = 393;
        rsInterface.childY[134] = 191;
        rsInterface.children[135] = 3695;
        rsInterface.childX[135] = 235;
        rsInterface.childY[135] = 245;
        rsInterface.children[136] = 3696;
        rsInterface.childX[136] = 236;
        rsInterface.childY[136] = 282;
        rsInterface.children[137] = 3697;
        rsInterface.childX[137] = 390;
        rsInterface.childY[137] = 258;
        rsInterface.children[138] = 3698;
        rsInterface.childX[138] = 325;
        rsInterface.childY[138] = 271;
        rsInterface.children[139] = 3699;
        rsInterface.childX[139] = 417;
        rsInterface.childY[139] = 271;
        rsInterface.children[140] = 3700;
        rsInterface.childX[140] = 348;
        rsInterface.childY[140] = 281;
        rsInterface.children[141] = 3701;
        rsInterface.childX[141] = 435;
