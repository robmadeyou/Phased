...
public final void method479(int i, int j, int k, int l, int i1, boolean flag)
    {
        ...
        {
            if(anIntArray1640 != null && anIntArray1639 != null && (anIntArray1640[i2] == 65535 || anIntArray1640[i2] == 0 || anIntArray1640[i2] == 16705))
                anIntArray1639[i2] = 255;
            int k2 = anIntArray1631[i2];
            int l2 = anIntArray1632[i2];
            int i3 = anIntArray1633[i2];
            int j3 = anIntArray1627[l2] - anIntArray1627[k2];
            int k3 = anIntArray1628[l2] - anIntArray1628[k2];
            int l3 = anIntArray1629[l2] - anIntArray1629[k2];
            int i4 = anIntArray1627[i3] - anIntArray1627[k2];
            int j4 = anIntArray1628[i3] - anIntArray1628[k2];
            int k4 = anIntArray1629[i3] - anIntArray1629[k2];
            int l4 = k3 * k4 - j4 * l3;
            int i5 = l3 * i4 - k4 * j3;
            int j5;
