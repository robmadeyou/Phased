	...
	implements Runnable
{
    ...
    public void start(NamedArchive streamLoader, Client client1)
    {
		...
		System.out.println("[508]Maps Amount: "+mapAmount+"");
	...
	private void handleFailed()
	{
		...
		while(uncompletedCount < 10)
		{
			...
			if(onDemandData_1 == null)
				break;
			System.out.println(onDemandData_1.ID + " in " + onDemandData_1.dataType + " is missing");
